...
| WRN16-3  | 94.5652 | 85.8696 | 90.2174 |  |  |
...
| Experiment  | Mean | Std |
|------------|---------|---------|
| WRN16-1  | **80.1107**xxx | 4.3123 |
| WRN16-3  | **81.0402**xxx | 4.9223 |
...
- 결과에 대한 나의 생각
  ...
  - 그래서 lambda값을 낮추고 싶긴한데, 정확한 값을 찾으려면 또 여러 번 학습을 진행해야 하는데, 이건 교수님과 의논해보자.
