...
<li> ** Foot Pressure-based Abnormal Gait Recognition with Multi-scale Cross-Attention Fusion - Cross Attention, Fig6를 완전히 이해해보자. (Attention 매커니즘 (Transformer 이해 필요.)) </li>
</ol>
...
<li> GAF Teacher 하나만 사용해서 각 조합마다 3번씩 학습해서 평균내기. </li>
