...
<li> Attention Score는 Softmax를 통해 확률로 변환되어, 입력 시퀀스의 각 Hidden State에 가중치를 부여한다. </li>
<li> Attention Score를 기반으로, 입력 Sequence의 Hidden State를 가중합하여 가중치 Context Vector를 생성한다. </li>
</ul>
<li>  </li>
