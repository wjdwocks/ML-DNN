...
### 해야 할 것
- VQShape - 1 → 토요일까지 생각해보고 일요일에 그림그려보는거로.. (생각만 정리해보자. 잘...)
- 제안서 - 2 → 1차년도 초안느낌으로 썼는데, 내용고도화 필요할듯. (완)
- 캡디 - 2 → 오늘 대부분 끝내기. 판넬은 다음주에 (완)
- 과제 - 2 → 오늘 안에 끝내자.. (완)
- 토익 - 3 → 안할 순 없어서 원래 하려던거 (미완)
- 3Teacher - 3 해야할 것만 정리해두고, 나중에 다시.. (ㅇㅇ)