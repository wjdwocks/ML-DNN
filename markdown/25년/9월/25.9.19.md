...
1. gwt model의 정의
    ...
    - <img src="https://github.com/wjdwocks/ML-DNN/raw/main/markdown/25년/9월/25.9.19/gwt_model.png" alt="results" width="700">
    ...
    - <img src="https://github.com/wjdwocks/ML-DNN/raw/main/markdown/25년/9월/25.9.19/gwt_obj.png" alt="results" width="700">
2. Student Model의 내부구조.
    ...
    - 그래서, 아레와 같이 Student 모델은 3번째 Stage의 Feature를 출력해주는 Encoder와, 변환된 Feature를 받아서 최종 확률분포를 출력해주는 Decoder로 나뉜다.
    - <img src="https://github.com/wjdwocks/ML-DNN/raw/main/markdown/25년/9월/25.9.19/student.png" alt="results" width="700">
3. gwt 모델의 내부 구조
    - 아레는 gwt모델의 생성자 부분인데, positional encoding을 하기 위한 pos_feat과, 사용할 각종 클래스의 객체를 생성하고, 
    ```python
