...
<li> Cosine 유사도와 Euclidean 유사도를 사용하는데, 둘 다 각 logits을 vector처럼 봐서 벡터의 norm의 크기 차이를 사용하던가, 내적을 통한 cosine 값을 통해 유사도를 평가한다. </li>
<li> 근데, T1과 T2의 유사도를 확인하고, T1과 S의 유사도를 그것과 비슷하게 함으로써 T1, T2의 지식을 모두 학습할 수 있다고 하는데 아직 이해가 안간다. </li>
</ul>
